...
public class AccountManager {
	public static void main(String[] args) {
		...
		account[0] = new Account(S,1234,"Mike",1000);
		account[1] = new Account(S,2345,"Adam",2000);
		account[2] = new Account(S,3456,"Linda",3000);
		account[3] = new Account(S,4567,"John",4000);
		account[4] = new Account(S,5678,"Rami",5000);
		account[5] = new Account(S,6789,"Lee",6000);
		account[6] = new Account(S,7890,"Tom",7000);
		account[7] = new Account(S,8901,"Lisa",8000);
		account[8] = new Account(S,9012,"Sam",9000);
		account[9] = new Account(S,4321,"Ted",10000);
